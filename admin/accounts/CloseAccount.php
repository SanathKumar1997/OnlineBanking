...
<head>
    ...
    <title>Close Account O B S</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body" style="height:75vh">
                                        <h5 class="card-title mb-4 ">Close Account</h5>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <form action="CloseAccount.php" method="POST">
                                                    <div class="input-group mb-3">
                                                        <input id="SearchTerm" name="SearchTerm" type="number" class="form-control" placeholder="Enter Account Number" aria-label="Recipient's username" aria-describedby="button-addon2">
                                                        <button class="btn btn-primary" name="SearchBtn" id="SearchBtn" type="button" id="button-addon2"> <i class="fas fa-search fa-sm"></i></button>
                                                    </div>
                                                </form>
                                        ...
                                        <div style="margin-top: 40px;" class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div id="SearchImg" class="text-center">
                                                    ...
                                                    <h1 id="heading" class="" style="margin-top: 30px;">Search Account Which You Want to Delete</h1>
                                                </div>

                                                <div class="table-responsive">

                                                    <!-- Search Table -->
                                                    <table hidden id="SearchTabel" class="table table-striped table-hover v-middle" style="margin-top: 30px;">
