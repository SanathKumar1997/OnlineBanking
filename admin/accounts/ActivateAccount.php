...
<head>
    ...
    <title>Activate Account O B S</title>
...
if (isset($_POST['Activate_btn'])) {
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-body ">
                                                <h5 class="card-title mb-4 ">Activate Account</h5>

                                                <form action="ActivateAccount.php" method="POST" class="d-none d-sm-inline-block form-inline navbar-search">
                                                    <div class="input-group">

                                                        <input id="SearchText" name="SearchText" style="margin: bottom 30px;" type="text" class="form-control border-bg" placeholder="Search for Account ..." aria-label="Search">
    ...
    $cursor = $collection->find(['Status' => 'Deactivated']);
