...
if (isset($_POST['EditTable_Edit_btn'])) {
    ...
    $cursor = $collection->find(['Account_No' => $EditAccountNo]);

    foreach ($cursor as $document) {
        // Access document fields here
        $EditFname = $document['C_First_Name'];
        $EditLname = $document['C_Last_Name'];
        $EditFaname = $document['C_Father_Name'];
        $EditManame = $document['C_Mother_Name'];
        $EditBDate = $document['C_Birth_Date'];
        $EditMobileNo = $document['C_Mobile_No'];
        $EditEmail = $document['C_Email'];
        $EditPincode = $document['C_Pincode'];
        $EditCitizenshipDoc = $document['C_Citizenship_Doc'];
        $EditPanDoc = $document['C_Pan_Doc'];
        $EditAccountNo = $document['Account_No'];
    }
...
if (isset($_POST['Update1'])) {
    ...
    if (!empty($EditEmail)) {
        if (!filter_var($EditEmail, FILTER_VALIDATE_EMAIL)) {
            ...
            $existingDocument = $collection->findOne(['C_Email' => $EditEmail]);
            if ($existingDocument && $existingDocument['Account_No'] !== $EditAccountNo) {
    ...
    // Name Validation
    $nameValidationRegex = '/\d+/'; // Regular expression to check for numeric values in the name

    if (empty($EditFname) || preg_match($nameValidationRegex, $EditFname)) {
        $First_Name_error = "* Please Enter a valid First Name";
    }

    if (empty($EditLname) || preg_match($nameValidationRegex, $EditLname)) {
        $Last_Name_error = "* Please Enter a valid Last Name";
    }

    if (empty($EditFaname) || preg_match($nameValidationRegex, $EditFaname)) {
        $Father_Name_error = "* Please Enter a valid Father Name";
    }

    if (empty($EditManame) || preg_match($nameValidationRegex, $EditManame)) {
        $Mother_Name_error = "* Please Enter a valid Mother Name";
    }

    // If no errors, proceed with the update
    if (empty($First_Name_error) && empty($Last_Name_error) && empty($Father_Name_error) && empty($Mother_Name_error) && empty($Birth_Date_error) && empty($Mobile_Number_error) && empty($Email_error) && empty($Pincode_error)) {
        $updateResult = $collection->updateOne(
            ['Account_No' => $EditAccountNo],
            ['$set' => [
                'C_First_Name' => $EditFname,
                'C_Last_Name' => $EditLname,
                'C_Father_Name' => $EditFaname,
                'C_Mother_Name' => $EditManame,
                'C_Birth_Date' => $EditBDate,
                'C_Mobile_No' => $EditMobileNo,
                'C_Email' => $EditEmail,
                'C_Pincode' => $EditPincode
            ]]
        );
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0">Edit Account #<?php echo $EditAccountNo ?></h1>

                                    <a href="../accounts/EditAccount.php"><button name="Edit_another" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm light"><i class="bx bxs-pencil ico"></i> Edit Another</button></a>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-body ">
                                                <h5 class="card-title mb-4 ">Update Account Details</h5>
                                                ...
                                                <form id="regForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="tab mb-3">
                                                        ...
                                                        <!-- <p class="SubAction dark" style="margin-top: 30px; margin: bottom 10px;">Update Personal Detail:</p> -->
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="text" name="FirstName" class="form-control" id="FirstName" placeholder="First Name" value="<?php echo $EditFname; ?>">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="text" name="LastName" class="form-control" id="Lname" placeholder="Last Name" value="<?php echo $EditLname; ?>">
                                                        ...
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="text" name="FatherName" class="form-control" id="FAname" placeholder="Father's Name" value="<?php echo $EditFaname; ?>">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="text" name="MotherName" class="form-control" id="MAname" placeholder="Mother's Name" value="<?php echo $EditManame; ?>">
                                                        ...
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="date" name="BirthDate" class="form-control m-wrap" id="BirthDate" placeholder="Birth Date" value="<?php echo strftime('%Y-%m-%d', strtotime($EditBDate)); ?>">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input name="MobileNumber" class="form-control" type="tel" id="MobileNo" pattern="[0-9]{10}" placeholder="Mobile Number" onkeypress="return isNumber(event)" value="<?php echo $EditMobileNo ?>">
                                                        ...
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email Address" value="<?php echo $EditEmail; ?>">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input name="pincode" class="form-control" type="tel" id="pincode" pattern="[0-9]{6}" placeholder="Pin Code" onkeypress="return isNumber(event)" value="<?php echo $EditPincode; ?>">
                                                        ...
                                                        <div class="mb-4" style="margin-top:40px; display:flex; align-items: center; justify-content:center;">
                                                            ...
                                                            <input type="submit" name="Update1" value="Update" class="btn btn-sm btn-primary shadow-sm" style="font-size:20px; width: 200px; height:40px;">
