...
$transactionsCollection = $mongoDB->selectCollection("transaction");
...
// Define options to sort documents by 'id' field in descending order
$options = ['sort' => ['id' => -1]];
...
// Check if any documents were found
    $increment = 1; // Initialize increment counter
